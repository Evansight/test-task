...
// });
    ...
    $(document).ready(function () {
        var answers = {}; // Об'єкт для збереження відповідей на питання

        $(".bq1").click(function () {
            answers["q1"] = $(this).text(); // Збереження відповіді на питання 1

            $("#q1").fadeOut("slow", function () {
                $("#q2").fadeIn("slow")
            })
        }), $(".bq2").click(function () {
            answers["q2"] = $(this).text(); // Збереження відповіді на питання 2

            $("#q2").fadeOut("slow", function () {
                $("#q3").fadeIn("slow")
            })
        }), $(".bq3").click(function () {
            answers["q3"] = $(this).text(); // Збереження відповіді на питання 3

            $("#q3").fadeOut("slow", function () {
                $("#q4").fadeIn("slow")
            })
        }), $(".bq4").click(function () {
            answers["q4"] = $(this).text(); // Збереження відповіді на питання 4
        ...
        document.getElementById("modal3-ok").addEventListener("click", function(event) {
            // забороняємо перехід на іншу сторінку за замовчуванням
            event.preventDefault();

            // тут ви можете написати код для виведення інформації в консоль
            for (const [question, answer] of Object.entries(answers)) {
                console.log(`Question ${question}: ${answer}`);
            }
            $("#p_modal3, .modal-backdrop").fadeOut();
